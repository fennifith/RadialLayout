...
public class RadialViewLayout extends FrameLayout {
    ...
    public RadialViewLayout(@NonNull Context context) {
        this(context, null);
    }

    public RadialViewLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RadialViewLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    public void setItems(List<RadialItem> items) {
        ...
        new Action() {
            ...
            protected Object run() throws InterruptedException {
                List<RadialItem> items = new ArrayList<>(RadialViewLayout.this.items);
            ...
            protected void done(@Nullable Object result) {
                ...
                if (width > 0 && height > 0) {
                    for (RadialItem item : RadialViewLayout.this.items) {
